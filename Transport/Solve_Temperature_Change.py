from Parameters import T_amb, n
from Properties.Heat_Of_Vaporization import heat_of_vaporization
from Properties.Heat_Of_Reaction import heat_of_reaction
